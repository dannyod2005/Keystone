...
export class CreateProvidersTable1785970000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "providers" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" text NOT NULL, "invite_code" text NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_providers_invite_code" UNIQUE ("invite_code"), CONSTRAINT "PK_providers_id" PRIMARY KEY ("id"))`,
    );
  }

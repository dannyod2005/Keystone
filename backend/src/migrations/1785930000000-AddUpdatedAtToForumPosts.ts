...
export class AddUpdatedAtToForumPosts1785930000000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "forum_posts" ADD "updated_at" TIMESTAMP`);
        await queryRunner.query(`UPDATE "forum_posts" SET "updated_at" = "created_at"`);
        await queryRunner.query(`ALTER TABLE "forum_posts" ALTER COLUMN "updated_at" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "forum_posts" ALTER COLUMN "updated_at" SET DEFAULT now()`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "forum_posts" DROP COLUMN "updated_at"`);
    }
